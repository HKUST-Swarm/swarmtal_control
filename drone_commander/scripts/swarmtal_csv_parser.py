...
def anaylze_csv(dataname, l=0, r=100000, plot=True):
    ...
    #     plt.title("Velocity")
        ax = plt.subplot(311)
        plt.plot(_t, csv_data['pos'][:,0], label="X_actual")
        plt.plot(_t, csv_data['pos_sp'][:,0], label="X_cmd")
    #     plt.plot(_t, csv_data['vel_des'][:,0], label="des_x")
        ...
        ax = plt.subplot(312)
        plt.plot(_t, csv_data['pos'][:,1], label="Y_actual")
        plt.plot(_t, csv_data['pos_sp'][:,1], label="Y_cmd")
    #     plt.plot(_t, csv_data['vel_des'][:,1], label="des_y")
        ...
        ax = plt.subplot(313)
        plt.plot(_t, csv_data['pos'][:,2], label="Z_actual")
        plt.plot(_t, csv_data['pos_sp'][:,2], label="Z_cmd")
